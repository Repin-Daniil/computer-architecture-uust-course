...
- [Вычислительные системы](#вычислительные-системы)
			...
			- [История вычислительных систем](#история-вычислительных-систем)
			- [Виды вычислительных систем](#виды-вычислительных-систем)
	...
	- [Компьютерные сети](#компьютерные-сети)
			- [Архитектуры взаимодействия](#архитектуры-взаимодействия)
						...
						- [«Издатель—брокер—подписчик»](#издатель-брокер-подписчик)
						- [«Peer-to-peer»](#peer-to-peer)
			- [Модель OSI](#модель-osi)
			- [Модель DoD. Стек протоколов TCP/IP](#модель-dod-стек-протоколов-tcp-ip)
